(function(b, c) {
  ...
  b.subAsiiStr = function(a, c, d, e) {
    for(var g = function(a) {
      return a
    }, f = e ? htmlEncode : g, a = (e ? htmlDecode : g)(b.trim((a || "").toString())), d = d || "", e = Math.max(c - d.length, 1), g = a.length, o = 0, t = -1, q, s = 0;s < g;s++) {
      if(q = a.charCodeAt(s), o += 35 == q || 87 == q ? 1.2 : 255 < q ? 1.5 : 1, -1 == t && o > e && (t = s), o > c) {
        return f(a.substr(0, t)) + d
      }
    }
    return f(a)
  };
  ...
  b.safe = function(a, b, c) {
    try {
      ...
      return console && console.error && console.error(d.stack), Log.e("JS Function: $.safe, e.message: " + d.message), -1
    }
  };
  ...
  b.isGif = function(h) {
    return developMode ? 2 == g(b.trim(h) || "", a) : !1
  };
...
(function() {
  ...
  function f(b, h) {
    var e, g, o, t, q = d, s, r = h[b];
    r && ("object" === typeof r && "function" === typeof r.toJSON) && (r = r.toJSON(b));
    "function" === typeof i && (r = i.call(h, b, r));
    switch(typeof r) {
      case "string":
        return c(r);
      case "number":
      ...
      case "object":
        ...
        if(i && "object" === typeof i) {
          t = i.length;
          for(e = 0;e < t;e += 1) {
            "string" === typeof i[e] && (g = i[e], (o = f(g, r)) && s.push(c(g) + (d ? ": " : ":") + o))
          }
        }else {
          for(g in r) {
            Object.prototype.hasOwnProperty.call(r, g) && (o = f(g, r)) && s.push(c(g) + (d ? ": " : ":") + o)
          }
        }
        o = 0 === s.length ? "{}" : d ? "{\n" + d + s.join(",\n" + d) + "\n" + q + "}" : "{" + s.join(",") + "}";
        d = q;
...
(function(b) {
  var c = {}, f = {}, g = function(d, a, h, i) {
    ...
    try {
      var g = WebMM.model("account").getSkey(), d = d + ("&skey=" + encodeURIComponent(g))
    }catch(f) {
    }
...
(function(b, c) {
  ...
  var d = function(a) {
    ...
    c && ("undefined" !== typeof d ? null !== d && "BODY" !== d.nodeName.toUpperCase() && (e = !0) : b.each(b.jPlayer.keyIgnoreElementNames.split(/\s+/g), function(b, c) {
...
(function(b, c) {
  ...
  k.prototype = {option:function(a, b) {
    ...
    function a(m) {
      ...
      var n = d._moOrgPos, u = n._nMouseY, n = Math.abs(n._nMouseX - m.clientX), u = Math.abs(u - m.clientY);
      if(d._mnState == e) {
        if(n > h.distance || u > h.distance) {
          d._mnState = f, d._start(m), d._moElement$.trigger("dragStart", [m, {helper:d._moMover$, position:{left:0, right:0}, offset:{left:0, right:0}}])
        }
      }else {
        d._mnState = g, d._drag(m), d._moElement$.trigger("drag", [m, {helper:d._moMover$, position:{left:0, right:0}, offset:{left:0, right:0}}])
      }
    }
    function c(g) {
...
(function(b, c) {
  var f = function(e, d) {
    ...
    var f = g._oContent$ = e, k = g._oContainer$ = e.parent(), m = g._oBarBox$ = b("<div/>").addClass("scrollbarBox"), j = g._oBar$ = b("<div/>").addClass("scrollbar");
    j.offsetTop = 0;
    j.setTop = function(a) {
      j.offsetTop = a;
      return j
    ...
    m.css({position:"absolute", right:"0", top:"0", height:"100%"}).on("mouseenter", function() {
      j.autoDisappear = !1;
      j.appear()
    ...
    k.append(m.append(j)).css({"overflow-y":"hidden", position:"relative"}).mousewheel(function(a, b) {
...
(function(b, c) {
  ...
  g.prototype = {setTriggers:function(c) {
    ...
    if(o.maxContainer) {
      var t = f && this._moPos[3] + b < this._moContainerPos[3], q = j && this._moPos[2] + a > this._moContainerPos[2], s = n && this._moPos[1] + b > this._moContainerPos[1];
  ...
  e.prototype = {setImg:function(b) {
    ...
    var a = this, e = a._moContainer, g = a._moDocument.createElement("div"), f = a._moDocument.createElement("img"), m = a._moDocument.createElement("img");
    e.innerHTML = "";
    ...
    a._moCropperImg = a._moWrapper.appendChild(m);
    b(a._moBaseImg).on("load", c);
    f.src = m.src = a._msImgPath;
    return a
    ...
    var a = this, f = b.now(), i = a._moOptions.resizeScale, k, m, j, n;
    k = 0;
    b.browser.msie || (k = 2);
    a._mnImgStyleWidth / a._mnImgStyleHeight > i ? (j = a._mnImgStyleHeight - k, n = j * i, k = 0, m = (a._mnImgStyleWidth - n) / 2) : (n = a._mnImgStyleWidth - k, j = n / i, k = (a._mnImgStyleHeight - j) / 2, m = 0);
    b(a._moWrapper).append(b.tmpl(e.TMPL.cropper, {_id:f, top:k + "px", left:m + "px", height:j + "px", width:n + "px"}));
    a._moCropper = b("#resizedom_" + f, a._moDocument)[0];
    var o = [[b("#rUp_" + f, a._moDocument)[0], "top"], [b("#rLeft_" + f, a._moDocument)[0], "left"], [b("#rDown_" + f, a._moDocument)[0], "bottom"], [b("#rRight_" + f, a._moDocument)[0], "right"], [b("#rLeftUp_" + f, a._moDocument)[0], "left-top"], [b("#rLeftDown_" + f, a._moDocument)[0], "left-bottom"], [b("#rRightUp_" + f, a._moDocument)[0], "right-top"], [b("#rRightDown_" + f, a._moDocument)[0], "right-bottom"]];
...
(function(b) {
  ...
  b.generateFlashCode = function(c, e, d, a) {
    var f = [], i = [], k = [], a = a || {}, m = b.browser.msie ? '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" <#=codebase#> <#=attr#> <#=id#> ><#=param#></object>' : '<embed <#=embed#> type="application/x-shockwave-flash" <#=pluginspage#>  <#=name#> <#=id#> ></embed>';
    ...
    return b.tmpl(m, {id:c && [' id="', c, '"'].join(""), name:c && [' name="', c, '"'].join(""), attr:f.join(""), param:i.join(""), embed:k.join(""), codebase:"https:" == location.protocol ? "" : 'codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" ', pluginspage:"https:" == location.protocol ? "" : 'pluginspage="http://www.adobe.com/cn/products/flashplayer" '})
  };
  b.getFlash = c;
  b.qmFlash = f
})(jQuery, this);
...
(function(b, c, f, g) {
  ...
  var a = {base:Class({init:function(a, b) {
    ...
    var h = b("#redirectDialog"), t = h.find(".dialogContent"), a = b("<div></div>").html(a);
    t.html(a.addClass(f ? f : "default"));
    ...
    h.off("keydown").on("keydown", function(a) {
      b.isHotkey(a, "enter") ? (h.hide(), d.ok(t)) : b.isHotkey(a, "esc") ? (h.hide(), d.cancel(t)) : a.stopPropagation()
    })
...
(function(b, c, f, g) {
  function e(a, e) {
    if(d <= a) {
      ...
      for(var g = {Type:1, Text:JSON.stringify(e), Uin:g, Date:(new Date).getTime()}, m = 0;m < e.length;m++) {
...
(function(b, c, f) {
  function g(a) {
    if("left" == a && 0 < r || "right" == a && r < s.length - 1) {
      "left" == a ? (r--, m.show()) : "right" == a && (r++, k.show());
      0 == r && k.hide();
      r == s.length - 1 && m.hide();
      var b = new Image;
      b.onload = function() {
  ...
  function d(a, c, d) {
    ...
    var y = c.parent(), h = function() {
      ...
      var a = 1, d = !1;
      t = function(b, c) {
        if(!(0 < b && (y.width() > r || y.height() > o))) {
          if(!(0 > b && (y.width() < I || y.height() < J))) {
            a += 0.2 * b;
            0.5 > a && (a = 0.5);
            var d = x.width, e = x.height;
            x.width = q * a;
            x.height = s * a;
            x.left = parseInt(y.css("left")) - (x.width - d) * (c.offsetX / d || 0.5);
            x.top = parseInt(y.css("top")) - (x.height - e) * (c.offsetY / e || 0.5);
            y.css(x)
          }
        }
      };
    ...
    d ? y.css({left:e.left, top:e.top, width:g, height:a}).show().animate(x, 500, "swing", h) : (y.css(x).show(), h())
  }
  function a(a) {
    var b = 0, c, d;
    if(0 == a.length) {
  ...
  var h = b("#slidePic"), i = b("#popImgOperator"), k = h.find(".prevImg"), m = h.find(".nextImg"), j = null, n, o, t, q, s, r;
  ...
  i.appear = function() {
    i.on && (q && clearTimeout(q), i.stop(!0, !0).animate({opacity:1}))
  };
  i.disappear = function() {
    i.on && (q && clearTimeout(q), q = setTimeout(function() {
    ...
    g.onload = function() {
      ...
      b("#mask").css("opacity", 0).show().stop().animate({opacity:0.6}, function() {
        ...
        b("#chatMainPanel").find("img.imageBorder").filter("[click=popImg]").each(function(c) {
          var d = b(this), g = d.attr("rawsrc"), f = d.attr("msgid"), g = /^blob:/.test(g) ? g : g + (-1 < g.indexOf("?") ? "&" : "?") + "__r=" + a(g);
          s.push({src:g, msgid:f, obj:d});
          e == f && (r = c)
        });
        k.show();
        m.show();
  ...
  c.widget = b.extend(c.widget || {}, {preLoadImg:function(c, d) {
    if(c && !w[c + (-1 < c.indexOf("?") ? "&" : "?") + "__r=" + a(c)]) {
      var e = new Image;
      e.onload = e.onerror = e.onabort = function() {
        w[this.src] && w[this.src].callback && b.safe(w[this.src].callback);
        delete w[this.src]
      };
      e.src = c + (-1 < c.indexOf("?") ? "&" : "?") + "__r=" + a(c);
      w[e.src] = {img:e, callback:d}
    }
...
(function(b, c, f) {
  ...
  function e(b, d) {
    ...
    e.ClearHeaders();
    e.ClearFormItems();
    e && (e.URL = c.getRes("url_host") + "/cgi-bin/mmwebwx-bin/webwxpreview?fun=upload&skey=" + encodeURIComponent(WebMM.model("account").getSkey()), e.AddHeader("Cookie", document.cookie), e.AddFormItem("msgimgrequest", 0, 0, b), e.AddFormItem("filename", 1, 4, !g() || !g() || !g().IsClipBoardImage ? !1 : g().SaveClipBoardBmpToFile(1)), e.OnEvent = function(a, b) {
      switch(b) {
        case 3:
...
(function(b, c, f) {
  function g(a, c, d, e) {
    ...
    e.quality = "high";
    for(var k in e) {
      var m = {name:k, value:e[k]};
      f.push(b.tmpl('<param name="<#=name#>" value="<#=value#>" />', m));
      h.push(b.tmpl(" <#=name#>=<#=value#> ", m))
    }
    for(k in d) {
      m = {name:k, value:d[k]}, g.push(b.tmpl(" <#=name#>=<#=value#> ", m)), h.push(b.tmpl(" <#=name#>=<#=value#> ", m))
    }
  ...
  function a(a, e) {
    ...
    if(a && 0 != a.size()) {
      var t = b.tmpl(k, {height:a.height(), width:a.width(), margin:0, code:g(h, c.getRes("swf_uploader") + "?r=" + b.now(), {width:"100%", height:"100%"}, {wmode:"transparent"})});
...
(function(b, c, f) {
  ...
  f.MMNotification = c.widget.notification = {notify:function(c, a, f, i) {
    if(this.isSupport()) {
      var i = b.extend(g, i), k = i.onclick, m = window.webkitNotifications;
      i.onclick = function() {
        e && (k.apply(this, arguments), e.cancel(), e = null)
      };
      0 == m.checkPermission() ? (e && (e.cancel(), e = null), e = m.createNotification(c, a, f), b.extend(e, i), setTimeout(function() {
        if(e) {
          e.show();
          clearTimeout(0);
          setTimeout(function() {
...
(function(b, c, f) {
  function g(a) {
    ...
    d.bind("click keyup keydown change", function(a) {
      ...
      a:for(;f < i;f++) {
        var j = b(k[f]);
        if(!h.globalIntercept || b.contains(h.interceptDom$[0], j[0])) {
          for(var m = j.parents("[ctrl]"), q = j.attr(a.type), n = q && q.split("@"), o = n && n[0], n = n && n[1], C = 0, G = m.length;q && C < G;C++) {
            var B = m[C].ctrl;
...
(function(b, c) {
  ...
  c.util = b.extend(c.util || {}, {isSpUser:function(a) {
    ...
    var g = c.model("contact").getChatroomContact(d.replace("@chatroom", ""), e.UserName);
    return g && g.DisplayName ? g.DisplayName : e.NickName || e.UserName
  }, isImgMsg:function(a) {
...
(function(b, c) {
  ...
  c.model("contact", {addContacts:function(b, e) {
    ...
    if(g && !c.util.isShieldUser(g.UserName)) {
      ...
      _oContacts[g.UserName] ? (c.util.isRoomContact(g.UserName) && 0 == g.MemberCount && (delete g.MemberCount, delete g.MemberList), g.OwnerUin = g.OwnerUin || _oContacts[g.UserName].OwnerUin, b.extend(_oContacts[g.UserName], g), e = "contactUpdated") : (_oContacts[g.UserName] = g, e = "contactAdded");
      ...
      a.DisplayName = a.DisplayName || c.util.getContactDisplayName(a);
      d = _oContacts;
      g = g.UserName;
...
(function(b, c, f, g) {
  ...
  function d(a, b) {
    for(var d = 0;d < a.length;++d) {
      var e = a[d];
      if(e.MsgType == c.Constants.MM_DATA_VERIFYMSG && e.RecommendInfo.UserName == b) {
        return d
      }
    }
    return-1
  ...
  c.addEventListener("accountUpdated", function(a) {
    ...
    if(a = a.avatar) {
      for(var d in j) {
        for(var e = j[d], g = 0, f = e.length;g < f;++g) {
          e[g].avatarId && e[g].avatarId == b && (e[g].avatar = a)
        }
      }
    }
  });
  c.model("message", {getMessages:function(a) {
    ...
    if(a && !c.util.isShieldUser(a)) {
      ...
      j[a] = [];
      var d = c.util.isFileHelper(a) && 0 == j[a].length ? 1E4 : -9999, e = 0 < d ? c.getRes("text_file_helper_tip") : "", b = 0 < d ? c.util.getServerTime() / 1E3 : b;
      this.addMessages([{MsgId:this.idIndex++, MsgType:d, FromUserName:"", ToUserName:a, Status:c.Constants.STATE_SENT, CreateTime:b ? b : c.util.getServerTime() / 1E3, Content:e, unread:!1}]);
      return!0
    }
    ...
    if(f = s) {
      b.isArray(f) || (f = [f]);
      for(var w = 0, z = f.length;w < z;w++) {
        var p = f[w], u = p.FromUserName, E = p.ToUserName, v = h(p), v = j[v] || (j[v] = []);
        Log.d("msgid=" + p.MsgId);
        m(p);
        p.actualSender = c.util.isRoomContact(u) ? c.util.getRoomMsgActualSender(p) : u;
        if(!(p.MsgType == c.Constants.MM_DATA_STATUSNOTIFY || c.util.isTalkContact(u) || c.util.isTalkContact(E) || c.util.isShieldUser(u) || c.util.isShieldUser(E) || p.MsgType == c.Constants.MM_DATA_VERIFYMSG && p.RecommendInfo && p.RecommendInfo.UserName == c.model("account").getUserInfo().UserName)) {
          if(p.MsgType == c.Constants.MM_DATA_RECALLED) {
            var u = b.xml2json(b.htmlDecode(a(p))).revokemsg, A;
            if(0 == u.msgid) {
              for(u = v.length - 1;0 <= u;--u) {
                if(v[u].FromUserName == c.model("account").getUserName()) {
                  A = u;
                  break
                }
              }
              u = c.getRes("recall_my_msg")
            }else {
              A = e(v, u.msgid), u = i(v[A]) ? c.getRes("recall_my_msg") : c.util.getContactDisplayName(p.actualSender) + " " + c.getRes("recall_ta_msg")
            }
            this.updateMessage(v, A, {MsgType:c.Constants.MM_DATA_SYS, Content:u, unread:!1, digest:u})
          }else {
            if(u = e(v, p.MsgId), 0 > u) {
              u = a(p);
              p.LocalID != g && p.LocalID == p.ClientMsgId && (u = c.widget.preFilterEmoji(u), u = b.htmlEncode(u), u = u.replace(/\n/g, "<br/>"), u = c.widget.afterFilterEmoji(u));
              p.LocalID || (p.ClientMsgId = p.LocalID = p.MsgId);
              p.digest = b.clearLinkTag(c.widget.filterQQFace(u));
              p.actualContent = b.hrefEncode(c.widget.filterQQFace(u));
              !i(p) && (p.unread == g && p.MsgType != c.Constants.MM_DATA_SYS) && (p.unread = !0);
              p.MsgType == c.Constants.MM_DATA_VERIFYMSG && (u = d(v, p.RecommendInfo.UserName), 0 > u ? p.History = ["0" + p.RecommendInfo.Content] : (u = v[u], u.History.push("0" + p.RecommendInfo.Content), p.History = u.History));
              ...
              n === g ? (k(v[v.length - 1], p), v.push(p)) : v.splice(n, 0, p);
              b.extend(p, o);
              p.isChatRoom = -1 != p.FromUserName.indexOf("@chatroom") ? 1 : 0;
              var v = "", F = this;
              1 == p.isChatRoom ? (v = p.FromUserName.replace("@chatroom", ""), WebMM.model("contact").getChatroomContact(v, p.actualSender) ? (v = c.util.getMemberDisplayName(p.actualSender, v), this.showMessage(v, p, n)) : b.netQueue().send("/cgi-bin/mmwebwx-bin/webwxbatchgetcontact?type=ex", b.extend(WebMM.model("account").getBaseRequest(), {Count:1, List:[{UserName:p.actualSender, ChatRoomId:v}]}), {onsuccess:function(a) {
                if(a != null && a.ContactList) {
                  var b = WebMM.model("contact"), c = a.ContactList[0];
                  c.ChatRoomId && c.UserName && b.addChatroomContact(c);
                  F.showMessage(a.ContactList[0].DisplayName, p, n)
                }else {
                  F.showMessage("", p, n)
                }
              }})) : this.showMessage(v, p, n)
            }else {
              this.updateMessage(v, u, p)
            }
          }
        }
      }
    ...
    b.DisplayName = a ? a : WebMM.model("contact").getContact(b.actualSender) && WebMM.model("contact").getContact(b.actualSender).DisplayName ? WebMM.model("contact").getContact(b.actualSender).DisplayName : b.actualSender || "";
...
(function(b, c) {
  ...
  MM_MEMBER_BLACKLIST:3, MM_MEMBER_NEEDVERIFYUSER:4, MM_MEMBER_UNSUPPORT_TALK:5})
})(jQuery, WebMM, this);
(function(b, c) {
  var f = [];
  ...
  c.logic("sync", {sync:function() {
    ...
    if(d.isStatusValid()) {
      if(a.isSyncing) {
        ...
        g = b.now();
        a.isSyncing = !0;
        var f = c.model("account"), i = f.getUserInfo(), k = f.getSid(), m = f.getSyncKey(), j = "/cgi-bin/mmwebwx-bin/webwxsync?sid=" + encodeURIComponent(k) + "&skey=" + encodeURIComponent(WebMM.model("account").getSkey()), n = {BaseRequest:{Uin:i.Uin, Sid:k}, SyncKey:m, rr:b.now()};
        b.netQueue().send(j, n, {onbefore:function() {
          ...
          if(null != g) {
            var i = b.safe(function() {
              g.SyncKey && (f.setSyncKey(g.SyncKey), Log.d(g.SyncKey));
              var a = g.AddMsgList;
              if(a) {
    ...
    if(d.isStatusValid()) {
      ...
      setTimeout(function() {
        ...
        for(var h = c.model("account"), j = h.getSid(), n = h.getUin(), h = h.getSyncKey().List, o = [], t = 0, q = h.length;t < q;t++) {
          o.push(h[t].Key + "_" + h[t].Val)
        }
        d.startMonitor();
        var s;
        try {
...
(function(b, c, f, g) {
  c.logic("sendMsg", {sendText:function(e, d) {
    ...
    var f = this, i = c.model("account").getSid(), k = "/cgi-bin/mmwebwx-bin/webwxsendmsg?sid=" + encodeURIComponent(i) + "&skey=" + encodeURIComponent(WebMM.model("account").getSkey());
    ...
    f["" + e.LocalID] = function(a, b) {
      ...
      g.FileUrl ? (-1 != b ? (g.Status = 2, g.MsgId = b) : g.Status = 5, c.triggerEvent("messageUpdated", g), d && d()) : c.widget.preLoadImg("/cgi-bin/mmwebwx-bin/webwxgetmsgimg?type=slave&MsgID=" + b + "&skey=" + encodeURIComponent(WebMM.model("account").getSkey()), function() {
...
(function(b, c) {
  ...
  c.logic("getconversation", {get:function(a) {
    ...
    var b = d.getContact(a), f = e.getLastMessage(a), k = b && b.DisplayName || f.actualSender || "", m = "", j = !1, n = "", o = "", t = e.getUnreadMsgsCount(a), q = b ? b.initOrder : 0;
    ...
    return{avatar:m, userName:a, name:k, time:n, unread:t, invisible:!1, type:f.MsgType, status:f.Status, digest:o, isRoom:j, memCount:j && b && b.MemberCount, initOrder:q, msgCreateTime:f.CreateTime, weight:g && b && b.weight || f.weight, muted:b && b.isMuted() || !1, contact:b}
  }})
})(jQuery, WebMM, this);
(function(b, c) {
  var f = !1;
  c.logic("contact", {getAllContacts:function() {
    f || b.netQueue().send("/cgi-bin/mmwebwx-bin/webwxgetcontact?skey=" + encodeURIComponent(WebMM.model("account").getSkey()), {}, {onsuccess:function(b) {
      if(b) {
  ...
  c.logic("modChatroom", {addMember:function(b, c, e) {
    ...
    b.netQueue("modChatroom").send("/cgi-bin/mmwebwx-bin/webwxupdatechatroom?fun=" + f, e, {onsuccess:function(e) {
      ...
      if("delmember" == f) {
        ...
        "modtopic" == f && (b('.chatListColumn[username="' + g + '"]').find(".nickName").find(".name").text(a), k.DisplayName = a, b("#messagePanelTitle").html(c.util.getChatTitle(k)), c.model("contact").addContact(k))
      }
...
(function(b, c, f) {
      ...
      if(b == e.getUserName()) {
        ...
        if(c.util.isRoomContact(b)) {
          ...
          if(k && k.HeadImgUrl) {
            ...
            try {
              i = "/cgi-bin/mmwebwx-bin/webwxgetheadimg?type=slave&username=" + encodeURIComponent(b) + "&count=" + (k && k.MemberCount) + "&skey=" + encodeURIComponent(WebMM.model("account").getSkey())
            }catch(m) {
              i = "/cgi-bin/mmwebwx-bin/webwxgetheadimg?type=slave&username=" + encodeURIComponent(b) + "&count=" + (k && k.MemberCount)
            }
          }
        }else {
  ...
  _fFormatTimeInDay = function(d, a) {
    ...
    var e = a.getHours(), g = "", g = 6 > e ? c.getRes("text_dawn") : 12 > e ? c.getRes("text_morning") : 13 > e ? c.getRes("text_noon") : 18 > e ? c.getRes("text_afternoon") : c.getRes("text_evening");
    12 < e && (e -= 12);
    return g + e + ":" + b.formatNum(a.getMinutes(), 2)
  };
  ...
  c.util.verificationPopup = function(d, a, e, g, f) {
    ...
    m && (e.confirm(b.tmpl(d), {ok:function() {
      ...
      c.logic("userverify").verify(m.RecommendInfo && m.RecommendInfo.UserName || m.UserName, f && f.type || c.Constants.MM_VERIFYUSER_SENDREQUEST, d, m && m.scene || 0, {onsuccess:function() {
        e.showTips(a.attr("addSuccTips"), !0, null);
        g && g.onsuccess && g.onsuccess(d)
      }, onerror:function() {
        e.showTips(a.attr("addErrTips"), !1, null);
        g && g.onerror && g.onerror()
      }}, f && f.ticket)
  ...
  c.util.verificationGroupPopup = function(d, a, e) {
    d && (a.confirm(b.tmpl("verification_add_group_request"), {ok:function() {
      var g = b("#verification_request"), f = b.stripStr(b.trim(g.find("input[type=text]").val()), 40);
      c.logic("userverify").verifyUniGroupList(d, c.Constants.MM_VERIFYUSER_SENDREQUEST, f, {onsuccess:function() {
        a.showTips(g.attr("addSuccTips"), !0, null);
        e && e.onsuccess && e.onsuccess(f)
      }, onerror:function() {
        a.showTips(g.attr("addErrTips"), !1, null);
        e && e.onerror && e.onerror()
      }})
    }}, "verificationRequest"), b.setInputLength(b("#verification_request").find("input"), 40))
  }
...
(function(b, c, f, g) {
  ...
  var h = "", i = "", k = !1, m = null, j = c.model("message"), n = [], o = !1, t = b("#vernierContainer .activeChatVernier"), q = null, s = 0, r = !1, w = 0, z = !1, p = null;
  c.createCtrl("chat_conversationListContent", {init:function() {
    ...
    i && !b.isLowerBrowser() && c.widget.scrollFocus(this.getDom$().parent(), p, t, a)
  }, chooseConversation:function(a, d) {
    d.addClass("activeColumn");
    var g = this._getUiConvDataIndex(i);
    0 <= g && 0 < n[g].unread && (k = j.markMsgsRead(i), this._handleConvItemDataChangeByUserName(i));
    k && (c.logic("sync").notifyMobile(i, 1), k = !1);
    g = d.attr("userName");
    if(k = j.markMsgsRead(g)) {
      c.logic("sync").notifyMobile(g, 1), k = !1, this._handleConvItemDataChangeByUserName(g)
    }
    if(h) {
      var f = c.model("message").getLastMessage(g);
      f && (f.weight = b.now())
    }
    e = !0;
    b.hash("#chat?userName=" + g)
    ...
    for(var e = 0, g = 0, f = n.length;e < f && 10 > g;e++) {
      if(n[e].invisible) {
        n[e].invisible = !1;
    ...
    for(var a = w = 0, d = n.length;a < d;a++) {
      var g = n[a];
      w += g.muted ? 0 : g.unread || 0
    }
    z && w ? q.html(w).show() : q.hide();
    if(!e) {
      if(0 < w) {
        b.flashTitle(b.tmpl(c.getRes("text_new_message_come"), {count:w}));
        ...
        if(h && c.model("account").isNotifyOpen()) {
          ...
          MMNotification.notify(h.avatar, b.tmpl(c.getRes("text_new_message_come"), {count:w}), b.subAsiiStr(b.clearHtmlStr(h.name + ": " + a), 50, "..."), {onclick:function() {
            f.focus();
    ...
    var g = c.util.getMsgPeerUserName(a);
    g == i && !r && e && d && j.markMsgsRead(i) && (k = !0);
    var f = this._getUiConvDataIndex(g);
    0 <= f ? (n[f].invisible = !1, this._handleConvItemDataChangeByUserName(g), this._sortConvAndUpateUi(g, f)) : h || (f = c.logic("getconversation").genConversation(g), n[0 < a.CreateTime ? "unshift" : "push"](f), 0 > a.MsgType && (0 > a.CreateTime && 15 < n.length && !o && g != i) && (f.invisible = !0), m[0 < a.CreateTime ? "prepend" : "append"](b.tmpl("chat_conversationItem", f)), this._handleConvItemDataChangeByUserName(g));
    this._convActive(!0);
    a = c.model("contact").getContact(g);
    ...
    if(b.isHotkey(a, "down") || b.isHotkey(a, "up")) {
      if(a.stopPropagation(), a.preventDefault(), !b.hash().endsWith("/contactlist")) {
        ...
        try {
          if(n[c]) {
            var g = b("#conv_" + b.getAsciiStr(n[c].userName));
            g.length && this.chooseConversation(a, g)
          }
        }catch(f) {
          alert(f)
        }
...
(function(b, c, f) {
  ...
  c.model("account");
  var d = 0, a = 0, h = 0, i = b.browser.msie && 9 > b.browser.version ? 300 : 0, k = 0, m = null, j = 0, n = 0, o = !1, t = !1, q = null;
  c.createCtrl("chat_chatmsglist", {init:function() {
    var a = this;
    a.getDom$().scrollable({onscroll:function(b) {
      0 != b || (o || t) || a._msgDelayLoad()
    }})
  }, active:function(a) {
    if(a.userName) {
      if(g == a.userName) {
    ...
    function a() {
      ...
      d.scrollBar ? (d.css("top", g - (d.height() - e)), d.scrollBar.resize()) : d.parent().scrollTop(d.height() - e - g);
      o = !1
    }
    o = !0;
    for(var c = [], d = this.getDom$(), e = d.height(), g = d.scrollBar ? parseInt(d.css("top")) : d.parent().scrollTop(), f = b("#chatListloadingMoreMsg"), h = 0;h < n;++h) {
      if(0 > j) {
        t = !0;
        break
      }
    ...
    1 == c.length && ("" == c[0].Content && 1 < m.length) && c.pop();
    clearTimeout(q);
    t || b(document).triggerHandler("mouseup");
    d.html() ? c.length && (f.length || (d.prepend(b.tmpl("chatListloadingMoreMsg", "")), f = b("#chatListloadingMoreMsg")), f.fadeIn("fast"), q = setTimeout(a, 1E3)) : a()
  }, messageAdded:function(a) {
    ...
    d == g && (this._removeNoMsgTip(), a.skey = encodeURIComponent(WebMM.model("account").getSkey()), this.getDom$().append(b.tmpl("chat_chatmsglist", [a])), a = this.getDom$().parent(), a.scrollTop() + a.height() < this.getDom$().height() - 1E3 || a.scrollTop(1E5))
  }, messageUpdated:function(a) {
    ...
    f.onbeforeunload = null;
    e = -1 == e.indexOf("fromuser=") ? e + ("&fromuser=" + c.model("account").getUserName()) : e.replace(/fromuser=[^&]*/i, "fromuser=" + c.model("account").getUserName());
...
(function(b, c) {
  ...
  c.createCtrl("createchatroom", {init:function() {
    ...
    for(var d = a.MemberList, e = "", g = c.model("contact"), f = 0, h = d.length;f < h;++f) {
      var i = d[f];
      i.MemberStatus == c.Constants.MM_MEMBER_BLACKLIST && (i = g.getContact(i.UserName), e += i.NickName || i.Alias || i.UserName, e += " , ")
    }
    e = e.substr(0, e.length - 2);
    0 < e.length && this.alert(b.tmpl("addBlackContactGroupErrTips", {Friends:e}), null, "verificationRequest");
    for(var k = a.ChatRoomName || j, m = [], n, o = "", f = 0, h = d.length;f < h;++f) {
      i = d[f], i.MemberStatus == c.Constants.MM_MEMBER_NEEDVERIFYUSER && m.push(i.UserName)
    }
    n = m.length;
    ...
    var a = this, e = [], g = c.model("account").getUserInfo().UserName;
...
(function(b, c, f) {
  ...
  c.createCtrl("chat_leftpanel", {init:function() {
    ...
    b("#conv_search").on("input propertychange blur", function(a) {
...
(function(b, c, f, g) {
  ...
  a.show();
  !m && h.show();
  var j = {}, n = b.browser.msie ? 300 : 0, o = 0, t = 0, q = 0, s = 0, r = null;
  c.createCtrl("chat_editor", {init:function() {
    var a = this;
    r = a.getDom$().find("textarea");
    b.textAreaResize(r[0], r.height(), 4 * r.height(), function(b) {
      a.getDom$().prev().height(function(a, c) {
        return c - b
      });
      a.getDom$().height(a.getDom$().height() + b)
    });
    r.on("paste", function(d) {
    ...
    o = setTimeout(function() {
      ...
      d != g && (r.val(c.model("history").inputRecord(d)), clearTimeout(t), t = setTimeout(function() {
        b.safe(function() {
          e(d) && r[0].focus()
        })
      }, 300))
    ...
    1 == q ? c.widget.Recorder.getObject().jStopRecording() : this._sendTextMsg(d.find(".chatInput"))
    ...
    var e = this, g = b.trim(a.val());
    0 == g.length ? setTimeout(function() {
      a.val("")[0].focus()
    }) : (a.val("")[0].focus(), c.logic("sendMsg").sendText({Msg:{FromUserName:c.model("account").getUserName(), ToUserName:d, Type:1, Content:g}}, {onerror:function(a) {
  ...
  }, _addAppMsg:function(a, e, g) {
    var f = b.now();
    if(b.isImg(a)) {
      return this._sendImgMsg(f, g), f
    }
    a = {FromUserName:c.model("account").getUserName(), ToUserName:d, Type:6, FileName:a, FileSize:e, Status:1, MsgId:f, ClientMsgId:f, LocalID:f, MsgType:49, CreateTime:Math.floor(f / 1E3)};
    ...
    if(c.widget.Recorder.isSupport()) {
      ...
      if(1 == q) {
        q = 0, c.widget.Recorder.getObject().jCancelRecording()
      }else {
        if(2 == q) {
          q = 0
        }else {
          ...
          c.widget.Recorder.install(g = {onReady:function(e) {
            ...
            1 == q && (a._sendVoice(b, c), e.toggle(), f.toggle(), q = 0)
          }, onSendError:function(b, d) {
            Log.e("JS Function: WebMM.widget.Recorder.install, Send Record Msg Error.");
            1 == q ? (a.cancelRecord(), a.alert("Record Error.")) : c.logic("sendMsg").finishSentAudio(b, d)
          }, onSendProgress:function() {
      ...
      if(f) {
        if(e) {
          for(var k = 0, m = f.MemberList && f.MemberList.length;k < m;k++) {
            ...
            n = "";
            j.ChatRoomId && WebMM.model("contact").getChatroomContact(j.ChatRoomId, j.UserName) && (n = WebMM.model("contact").getChatroomContact(j.ChatRoomId, j.UserName).DisplayName);
            j.DisplayName = n || j.DisplayName;
            i.push(j)
          }
        }else {
          i.push(f)
...
(function(b, c) {
  ...
  c.createCtrl("chat_contactListContent", {init:function() {
    ...
    if(!a || e) {
      var h = c.model("contact").getAllFriendContact(g, !g, {}, !g), n = !g && c.model("contact").getAllStarContact() || [], o = c.model("contact").getAllFriendChatroomContact(g) || [], t = !g && c.model("contact").getAllBrandContact() || [], q = this, s = b.tmpl("contactlist", {init:d, curUserName:f, isSearch:!!g, contacts:h, starContacts:n, roomContacts:o, brandContacts:t, invisible:i});
      i = !1;
      setTimeout(function() {
        q.getDom$().find("#contactListContainer").html(s);
        q._contactImgLoad()
      });
      d || (a = !0)
    }
